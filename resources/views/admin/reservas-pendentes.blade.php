    ...
    <div class="card col-md-10 col-sm-12 mx-auto shadow-lg">
        ...
        <div class="card-body bg-cinza2">
                ...
                <table class="table table-hover table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ \Carbon\Carbon::parse($reserva->solicitadoEm)->format('d/m/Y H:i') }}</td>
                            <td>
            ...
            <div class="alert alert-info text-center">
                <i class="fas fa-info-circle"></i> Não há reservas pendentes no momento.
            </div>
            @endif
        </div>
